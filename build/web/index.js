...
// end include: /tmp/tmp305xrv1k.js
// include: /tmp/tmpw068jfcn.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if (Module['$ww'] || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmpw068jfcn.js
// include: /tmp/tmpbx33i65w.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmpbx33i65w.js
...
var ASM_CONSTS = {
 ...
 125554: () => { return parseInt(document.getElementById('canvas').style.width); },  
 125622: () => { document.exitFullscreen(); },  
 125649: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 125722: () => { if (document.fullscreenElement) return 1; },  
 125768: () => { return document.getElementById('canvas').width; },  
 125820: () => { return screen.width; },  
 125845: () => { document.exitFullscreen(); },  
 125872: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 126005: () => { return window.innerWidth; },  
 126031: () => { return window.innerHeight; },  
 126058: () => { if (document.fullscreenElement) return 1; },  
 126104: () => { return document.getElementById('canvas').width; },  
 126156: () => { return parseInt(document.getElementById('canvas').style.width); },  
 126224: () => { if (document.fullscreenElement) return 1; },  
 126270: () => { return document.getElementById('canvas').width; },  
 126322: () => { return screen.width; },  
 126347: () => { return window.innerWidth; },  
 126373: () => { return window.innerHeight; },  
 126400: () => { if (document.fullscreenElement) return 1; },  
 126446: () => { return document.getElementById('canvas').width; },  
 126498: () => { return screen.width; },  
 126523: () => { document.exitFullscreen(); },  
 126550: () => { if (document.fullscreenElement) return 1; },  
 126596: () => { return document.getElementById('canvas').width; },  
 126648: () => { return parseInt(document.getElementById('canvas').style.width); },  
 126716: () => { document.exitFullscreen(); },  
 126743: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 126801: () => { return screen.width; },  
 126826: () => { return screen.height; },  
 126852: () => { return window.screenX; },  
 126879: () => { return window.screenY; },  
 126906: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 126959: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 127030: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 127087: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 127343: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 127414: () => { if (document.fullscreenElement) return 1; },  
 127460: () => { return window.innerWidth; },  
 127486: () => { return window.innerHeight; },  
 127513: () => { if (document.pointerLockElement) return 1; }
};
